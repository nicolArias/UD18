...
public class CrudDepartamentos extends ConexionBD{
	...
	public String createTable(String nomBD) {
		...
		try {
			...
			mensaje="Tabla 'Departamentos' creada con exito";
			...
			mensaje="Error creando tabla 'Departamentos'";
		}
		return mensaje;
	}
	
	//METODO QUE INSERTA DATOS EN TABLAS MYSQL
	public String insertData(String nomBD,int codigo,String nombre,int presupuesto) {
		...
		try {
			...
			String Query = "INSERT INTO Departamentos VALUE(" 
					+ "\"" + codigo + "\","
					+ "\"" + nombre + "\","
					+"\""+presupuesto+"\");";
	...
	public  String deleteRecord(String nomBD,int codigo) {
		...
		try {
			...
			mensaje="Registros de tabla 'Departamentos' ELIMINADOS con exito!";
	...
	public String deleteTabla(String nomBD) {
		...
		try {
			...
			String Query = "DROP TABLE Departamentos;";
			Statement st = getConexion().createStatement();
			st.executeUpdate(Query);
			
			mensaje="TABLA 'Departamentos' ELIMINADA con exito!";
